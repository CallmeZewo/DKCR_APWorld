...
CUSTOM_RAM_POINTER = 0x817fc3c0
CUSTOM_LAST_ITEM_INDEX_ADDR = 0x817fc3bc
CUSTOM_PP_AMOUNT_ADDR = 0x817fc3b8
CUSTOM_ORB_BITFLAG_ADDR = 0x817fc3ac
...
CUSTOM_KL_AMOUNT_ADDR = 0x817fc3b0
JGL_KL_OFFSET = 0x0
BCH_KL_OFFSET = 0x1
RNS_KL_OFFSET = 0x2
CVE_KL_OFFSET = 0x3
...
CUSTOM_LEVEL_BITFLAG_ADDR = 0x817fc3a0

level_bitflags = {
    L.HANDY_HAZARDS: 0x0,
    L.WONKY_WATERWAY: 0x1,
    L.CLIFFTOP_CLIMB: 0x2,
    L.SLAMMIN_STEEL: 0x3,
    L.FOGGY_FUMES: 0x4,
    L.MOVING_MELTERS: 0x5,
    L.MUSIC_MADNESS: 0x6,
    L.TIKI_TONG_TERROR: 0x7,
    L.KING_OF_CLING: 0x8,
    L.SPRINGY_SPORES: 0x9,
    L.BLOWHOLE_BOUND: 0xa,
    L.CANNON_CLUSTER: 0xb,
    L.GOLDEN_TEMPLE: 0xc,
    L.JAGGED_JEWELS: 0xd,
    L.DAMP_DUNGEON: 0xe,
    L.BOMBS_AWAY: 0xf,
    L.SWITCHEROO: 0x10,
    L.STICKY_SITUATION: 0x11,
    L.VINE_VALLEY: 0x12,
    L.BOULDER_ROLLER: 0x13,
    L.TUMBLIN_TEMPLE: 0x14,
    L.FIVE_MONKEY_TRIAL: 0x15,
    L.FOREST_SHOP: 0x16,
    L.ITTY_BITTY_BITERS: 0x17,
    L.SMOKEY_PEAK: 0x18,
    L.TIDAL_TERROR: 0x19,
    L.CRUMBLE_CANYON: 0x1a,
    L.MAST_BLAST: 0x1b,
    L.BLAST_N_BOUNCE: 0x1c,
    L.TIPPIN_TOTEMS: 0x1d,
    L.HOT_ROCKET: 0x1e,
    L.RUINS_SHOP: 0x1f,
    L.MOLE_PATROL: 0x20,
    L.GEAR_GETAWAY: 0x21,
    L.TIPPY_SHIPPY: 0x22,
    L.LIFT_OFF_LAUNCH: 0x23,
    L.MUGLYS_MOUND: 0x24,
    L.FURIOUS_FIRE: 0x25,
    L.MUNCHER_MARATHON: 0x26,
    L.SUNSET_SHORE: 0x27,
    L.CLINGY_SWINGY: 0x28,
    L.TREE_TOP_BOP: 0x29,
    L.GRIP_N_TRIP: 0x2a,
    L.FEATHER_FIEND: 0x2b,
    L.BEACH_SHOP: 0x2c,
    L.RUINED_ROOST: 0x2d,
    L.JUNGLE_SHOP: 0x2e,
    L.TEMPLE_TOPPLE: 0x2f,
    L.TREACHEROUS_TRACK: 0x30,
    L.WEIGHTY_WAY: 0x31,
    L.JUNGLE_HIJINXS: 0x32,
    L.PERILOUS_PASSAGE: 0x33,
    L.STORMY_SHORE: 0x34,
    L.VOLCANO_SHOP: 0x35,
    L.CROWDED_CAVERN: 0x36,
    L.ROASTING_RAILS: 0x37,
    L.POPPIN_PLANKS: 0x38,
    L.WIGGLEVINE_WONDERS: 0x39,
    L.SLOPPY_SANDS: 0x3a,
    L.PRECARIOUS_PLATEAU: 0x3b,
    L.CAVE_SHOP: 0x3c,
    L.RED_RED_RISING: 0x3d,
    L.THE_MOLE_TRAIN: 0x3e,
    L.MANGORUBY_RUN: 0x3f,
    L.FACTORY_SHOP: 0x40,
    L.BOBBING_BASALT: 0x41,
    L.COG_JOG: 0x42,
    L.PEACEFUL_PIER: 0x43,
    L.PINCHIN_PIRATES: 0x44,
    L.PLATFORM_PANIC: 0x45,
    L.SHIFTY_SMASHERS: 0x46,
    L.CRAZY_CART: 0x47,
    L.CANOPY_CANNONS: 0x48,
    L.CLIFF_SHOP: 0x49,
    L.RICKETY_RAILS: 0x4a,
    L.THUGLYS_HIGHRISE: 0x4b,
    L.FLUTTER_FLYAWAY: 0x4c,
    L.LONGSHOT_LAUNCH: 0x4d,
    L.PREHISTORIC_PATH: 0x4e,
    L.BUTTON_BASH: 0x4f,
}

CUSTOM_KEY_BITFLAG_ADDR = 0x817fc39c
...
CUSTOM_MIRROR_SHARD_ADDR = 0x817fc398

CUSTOM_FACTORY_BUTTON_ADDR = 0x817fc394
